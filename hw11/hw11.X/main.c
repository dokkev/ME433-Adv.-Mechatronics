...
int main() {
    ...
    while(1) {
        ...
        sprintf(m, "g: %d %d %d", data_arr[4], data_arr[5], data_arr[6]);
        drawString(10, 10, WHITE, m);
        
        sprintf(m, "a: %d %d %d", data_arr[1], data_arr[2], data_arr[3]);
        drawString(10, 20, WHITE, m);
 
        sprintf(m, "T: %d", data_arr[0]);
        drawString(10, 30, WHITE, m);

        sprintf(m,"___________________________________________");
        ...
        float fps = 24000000/delay; 
        sprintf(m, "FPS = %.2f", fps);
        drawString(10, 220, WHITE, m); 
